...
| [alternativas-hpux/](./alternativas-hpux/) | Alternativas para IHS en HP-UX (mod_status + Machine Agent + Python). Host Linux: 1 CPU, 4 GB RAM mín.; Python instalado; conectividad Linux ↔ IHS. |
